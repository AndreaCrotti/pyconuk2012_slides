...
extensions = ['sphinx.ext.pngmath', 'sphinx.ext.viewcode', 'hieroglyph', 'sphinx.ext.ditaa']
...
latex_documents = [
  ('index', 'pyconslidesa.tex', u'pycon slidesa Documentation',
   u'Andrea Crotti', 'manual'),
]
...
man_pages = [
    ('index', 'pyconslidesa', u'pycon slidesa Documentation',
     [u'Andrea Crotti'], 1)
]
...
texinfo_documents = [
  ('index', 'pyconslidesa', u'pycon slidesa Documentation',
   u'Andrea Crotti', 'pyconslidesa', 'One line description of project.',
   'Miscellaneous'),
]
